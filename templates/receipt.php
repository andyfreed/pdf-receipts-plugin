...
<body>
    <div class="bhfe-receipt">
        ...
        <section class="bhfe-receipt__meta">
            ...
            <div class="bhfe-receipt__meta-right">
                <p><strong><?php esc_html_e( 'Payment Date:', 'bhfe-pdf-receipts' ); ?></strong> <?php echo esc_html( wc_format_datetime( $payment_date, get_option( 'date_format' ) ) ); ?></p>
                <p><strong><?php esc_html_e( 'Payment Method:', 'bhfe-pdf-receipts' ); ?></strong> <?php echo esc_html( $payment_method . ( $card_last4 ? sprintf( ' ending in %s', $card_last4 ) : '' ) ); ?></p>
                <p><strong><?php esc_html_e( 'Order Number:', 'bhfe-pdf-receipts' ); ?></strong> <?php echo esc_html( $order->get_order_number() ); ?></p>
            </div>
        </section>
        ...
        <table class="bhfe-receipt__items">
            <thead>
                <tr>
                    ...
                    <th><?php esc_html_e( 'Quantity', 'bhfe-pdf-receipts' ); ?></th>
